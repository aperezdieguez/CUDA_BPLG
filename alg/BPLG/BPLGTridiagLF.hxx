...
#pragma once
#ifndef BPLG_TRIDIAG_LF_HXX
#define BPLG_TRIDIAG_LF_HXX
...
class BPLGTridiagLF : public Transform {

public:

	// Creates a transform, batch is the last dimension
	BPLGTridiagLF(int dimX, int dimY = 1, int dimZ = 1) :
	...
	inline const char* toString() { return "BPLGTridiagLF"; }
