//- =======================================================================
//+ BPLG Real Tridiagonal CR Systems v1.0
//- =======================================================================

#pragma once
#ifndef BPLG_TRIDIAG_CR_HXX
#define BPLG_TRIDIAG_CR_HXX
...
class BPLGTridiagCR : public Transform {

public:

	// Creates a transform, batch is the last dimension
	BPLGTridiagCR(int dimX, int dimY = 1, int dimZ = 1) :
	...
	inline const char* toString() { return "BPLGTridiagCR"; }
